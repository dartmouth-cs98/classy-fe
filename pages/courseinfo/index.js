...
import Medians from '../../components/Medians';
import { convertMedian } from '../../components/Medians';
import StudentsSay from '../../components/StudentsSay';

export default function CourseInfo() {
    const data = CourseData();
    const currentCourse = data["COSC 10"];
    return (
        <>
            <div className={styles.container}>
                ...
                <Glance distribs={currentCourse.distribs} wc={currentCourse.wc} avgMedian={convertMedian(currentCourse.avgMedian)} waitlist={currentCourse.waitlist}/>
                ...
                <StudentsSay workload={currentCourse.workload} difficulty={currentCourse.difficulty} quality={currentCourse.quality}/>
