...
export const colors = [
  { pastel: 'var(--pastel-blue)', dark: 'var(--dark-blue)' },
  { pastel: 'var(--pastel-green)', dark: 'var(--dark-green)' },
  { pastel: 'var(--pastel-purple)', dark: 'var(--dark-purple)' },
  { pastel: 'var(--pastel-orange)', dark: 'var(--dark-orange)' },
  { pastel: 'var(--pastel-pink)', dark: 'var(--dark-pink)' },
  { pastel: 'var(--pastel-violet)', dark: 'var(--dark-violet)' },
];
